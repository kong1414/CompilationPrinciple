<template>
  <div class="home">
    ...
    <el-row>
      <el-button type="info"
                 @click="restart"
                 style="margin: 0 auto">初始化</el-button>
      <el-button type="info"
                 @click="getDemo"
                 style="margin: 0 auto">DEMO</el-button>
    </el-row>
    ...
    <el-row>
      <el-button @click="handleInputEnd">提交终结符</el-button>
    </el-row>
    <!-- 产生式 -->
    <el-row :gutter="20">
      <el-card>
    ...
    <el-row>
      <el-button @click="handlePro">提交产生式</el-button>
    </el-row>
    <!-- first,follow -->
    <el-row :gutter="20">
      <el-col :span="12">
